...
import { EXPERIENCE_ENTRIES as ENTRIES, type ExperienceEntry as Entry } from "@/data/portfolio";
    ...
    <div className="flex flex-col gap-3">
      ...
      >
        <motion.div
          ...
          initial={false}
          animate={{
            height: hiddenCount > 0 ? (open ? "auto" : collapsedHeight) : "auto",
          }}
          ...
          <ul className="flex flex-col gap-2">
            {ENTRIES.map((entry, i) => (
              <motion.li
                ...
                className="bg-background border-foreground/5 flex items-start gap-4 rounded-3xl border p-3 sm:p-4"
              >
