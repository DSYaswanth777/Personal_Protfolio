        ...
        <div ref={menuRef}>
          <ul
            className={`${
              isMenuOpen
                ? "md:flex "
                : "md:flex md:items-center z-[-1] gap-10 md:z-auto md:static absolute w-full left-0 md:w-auto md:py-0 py-4 md:pl-0 pl-7 md:opacity-100 opacity-0 top-[-300px] transition-all ease-in duration-500 backdrop-blur-md "
